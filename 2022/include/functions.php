...
# Copyright (C) 2019, 2022, 2021 Valerio Bozzolan and contributors
#
 ...
 */
function template_2022( $template_name, $template_args = [] ) {
	extract( $template_args, EXTR_SKIP );
	return require ABSPATH . "/2022/template/$template_name.php";
}
...
function event_2022( $id ) {
	...
	template_2022( 'event-brief', [
		'event' => $event,
	] );
}

/**
 * Print an icon for the 2022 website
 *
 ...
 * @return string
 */
function icon_2022( $name, $classes = null ) {
 ...
 * @return Generator
 */
function event_users_2022( $event, $role ) {
...
/**
 * Link to an User of the itWikiCon 2022
 *
 * @param User $user
 * @return string HTML firm
 */
function user_link_2022( $user ) {
